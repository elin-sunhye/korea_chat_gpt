...
INSERT INTO `course` VALUES ('데이터베이스론','김 교수','홍길동','컴퓨터공학','남'),('데이터베이스론','김 교수','김영희','소프트웨어공학','여'),('데이터베이스론','김 교수','김철수','컴퓨터공학','남'),('알고리즘','박 교수','김영희','소프트웨어공학','여'),('알고리즘','박 교수','김철수','컴퓨터공학','남'),('운영체제','이 교수','홍길동','컴퓨터공학','남');
...
-- Dump completed on 2025-01-07 17:26:15
